...
std::string FileFullName::getFileNameWithoutExtension() const { return _fileNameWithoutExtension; }

std::string FileFullName::getFileExtension() const { return _fileExtension; }

std::string FileFullName::getFullName() const { return _fileNameWithoutExtension + "." + _fileExtension; }
